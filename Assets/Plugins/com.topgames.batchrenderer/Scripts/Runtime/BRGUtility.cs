...
public static class BRGUtility
{
    ...
    public static readonly int kSizeOfFloat = sizeof(float);
    public static readonly int kBytesPerInstance = kSizeOfPackedMatrix * 2 + kSizeOfFloat4 * 3;
    public static readonly int kSizeOfBatchDrawCommand=32;
    public static readonly int kExtraBytes = kSizeOfMatrix * 2;
    public static readonly int kSizeOfInt=4;
