...
Shader "GPUAnimation/GPUAttachBone2D"
{
	Properties
	{
		...
		_AttachBoneIndex("AttachBoneIndex", Int) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 appendResult59_g42 = (float2(( _AnimTex_TexelSize.x * ( _AnimTex_TexelSize.z - 0.5 ) ) , ( _AnimTex_TexelSize.y * ( _AnimTex_TexelSize.w - ( (float)_AttachBoneIndex + 0.5 ) ) )));
				float temp_output_17_0_g42 = ( tex2Dlod( _AnimTex, float4( appendResult59_g42, 0, 0.0) ).r + 0.5 );
				float2 appendResult8_g41 = (float2(( ( _AnimTex_TexelSize.z - 0.5 ) / _AnimTex_TexelSize.z ) , ( ( _ClipId.x + 0.5 ) / _AnimTex_TexelSize.w )));
				float4 tex2DNode9_g41 = tex2Dlod( _AnimTex, float4( appendResult8_g41, 0, 0.0) );
				float temp_output_136_0_g40 = ( ( _TimeParameters.x - _ClipId.y ) * _AnimSpeed );
				float temp_output_128_11_g40 = tex2DNode9_g41.b;
				float ifLocalVar14_g40 = 0;
				if( tex2DNode9_g41.a <= 0.1 )
				ifLocalVar14_g40 = temp_output_136_0_g40;
				else
				ifLocalVar14_g40 = fmod( temp_output_136_0_g40 , temp_output_128_11_g40 );
				float lerpResult18_g40 = lerp( tex2DNode9_g41.r , tex2DNode9_g41.g , saturate( ( ifLocalVar14_g40 / temp_output_128_11_g40 ) ));
				float temp_output_2_0_g42 = ( ( lerpResult18_g40 + 0.5 ) / _AnimTex_TexelSize.w );
				float2 appendResult19_g42 = (float2(( _AnimTex_TexelSize.x * temp_output_17_0_g42 ) , temp_output_2_0_g42));
				float temp_output_62_0_g42 = ( ( _AnimTex_TexelSize.z - 1.0 ) / 3.0 );
				float2 appendResult23_g42 = (float2(( _AnimTex_TexelSize.x * ( temp_output_17_0_g42 + temp_output_62_0_g42 ) ) , temp_output_2_0_g42));
				float2 appendResult27_g42 = (float2(( _AnimTex_TexelSize.x * ( temp_output_17_0_g42 + ( temp_output_62_0_g42 * 2.0 ) ) ) , temp_output_2_0_g42));
				float4x4 temp_output_155_0_g40 = float4x4(tex2Dlod( _AnimTex, float4( appendResult19_g42, 0, 0.0) ), tex2Dlod( _AnimTex, float4( appendResult23_g42, 0, 0.0) ), tex2Dlod( _AnimTex, float4( appendResult27_g42, 0, 0.0) ), float4(0,0,0,1));
				...
				float3 vertexValue = mul( temp_output_155_0_g40, v.vertex ).xyz;
						 ...
						 ) : SV_Target
			{
				...
				float3 BaseColor = ( tex2DNode82 * _Color ).rgb;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;87,-283;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;GPUAnimation/GPUAttachBone2D;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;20;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;1;638408040651918802;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;638392673952806190;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;0;638398601787673286;Debug Display;0;638386636213468559;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.ColorNode;17;-787,-442.5;Inherit;False;Property;_Color;Color;4;0;Create;True;0;0;0;False;1;MainColor;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;82;-858,-628.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;1;MainTex;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;96;-845.5,185.0997;Inherit;False;Property;_AttachBoneIndex;AttachBoneIndex;5;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;116;-377.5,-102.9003;Inherit;False;GPUAttachBoneAnim;-1;;40;94b9177ca50b12e43a793d42b613117b;0;5;2;SAMPLER2D;0;False;4;FLOAT;0;False;5;FLOAT;1;False;135;FLOAT;0;False;138;FLOAT;0;False;2;FLOAT4;0;FLOAT3;1
Node;AmplifyShaderEditor.Vector3Node;117;-250.5,84.79987;Inherit;False;Constant;_Vector1;Vector 1;6;0;Create;True;0;0;0;False;0;False;1,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
WireConnection;1;0;83;0
WireConnection;1;6;82;4
WireConnection;1;8;116;0
WireConnection;1;10;117;0
WireConnection;83;0;82;0
WireConnection;83;1;17;0
WireConnection;116;2;13;0
WireConnection;116;4;15;1
WireConnection;116;5;16;0
WireConnection;116;135;15;2
WireConnection;116;138;96;0
ASEEND*/
//CHKSM=6F9BF46EF86E1EE72BCF542A6EAAE38650F85275