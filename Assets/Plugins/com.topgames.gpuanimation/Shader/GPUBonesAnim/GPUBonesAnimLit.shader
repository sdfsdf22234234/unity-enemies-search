...
Shader "GPUAnimation/GPUBonesAnimLit"
{
	Properties
	{
		...
		[Toggle(_ALPHACLIPPING_ON)] _AlphaClipping("AlphaClipping", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
				...
				UNITY_DOTS_INSTANCED_PROP(float, _AlphaClipThreshold)
			...
			#define _AlphaClipThreshold UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _AlphaClipThreshold)
			#endif
						 ...
						 ) : SV_Target
			{
				...
				float clampResult20_g47 = clamp( ( ( _TimeParameters.x - _UserdataVec4.x ) * 4.0 ) , 0.0 , 1.0 );
				...
				float3 Emission = ( _BlinkColor * saturate( ( ( abs( ( ( temp_output_1_0_g48 - floor( ( temp_output_1_0_g48 + 0.5 ) ) ) * 2 ) ) * 2 ) - 1.0 ) ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-608,544;Inherit;False;Property;_AlphaClipThreshold;AlphaClipThreshold;7;0;Create;True;0;0;1;;False;0;True;0.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;94;-736,176;Inherit;False;Property;_UserdataVec4;UserdataVec4;8;0;Create;True;0;0;0;False;0;True;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;96;-176,256;Inherit;False;EmissionBlink;-1;;47;0ac8dc5f1f29b7f4abb8639f8d44d30f;0;2;12;FLOAT;0;False;11;COLOR;1,1,1,1;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;95;-448,320;Inherit;False;Property;_BlinkColor;BlinkColor;5;0;Create;True;0;0;0;False;1;MainColor;True;1,1,1,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StaticSwitch;88;-272,560;Inherit;False;Property;_AlphaClipping;AlphaClipping;6;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
WireConnection;96;12;94;1
WireConnection;96;11;95;0
...
ASEEND*/
//CHKSM=D1A47D6274A182AAD5CD5392563603A965F49BA4